...
# face detection
face_detector_model = cv2.dnn.readNetFromCaffe(os.path.join(BASE_DIR,'static/models/deploy.prototxt.txt'),
                                               os.path.join(BASE_DIR,'static/models/res10_300x300_ssd_iter_140000_fp16.caffemodel'))
# feature extraction
face_feature_model = cv2.dnn.readNetFromTorch(os.path.join(BASE_DIR,'static/models/openface.nn4.small2.v1.t7'))
# face recognition
face_recognition_model = pickle.load(open(os.path.join(BASE_DIR,'static/models/custom_model_face_recognition.pkl'),
                                          mode='rb'))
# emotion recognition model
emotion_recognition_model = pickle.load(open(os.path.join(BASE_DIR,'static/models/custom_model_face__emotion_recognition_voting_soft.pkl'),mode='rb'))
